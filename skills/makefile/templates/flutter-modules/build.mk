...
flutter-build-ipa: _check-flutter _check-export-options ## Build IPA for App Store distribution
	...
	if [ -n "$$IPA_FILE" ]; then \
		...
		printf "\n"; \
		printf "  $(DIM)Review the log for details, then re-run:$(RESET)\n"; \
		printf "     $(CYAN)make flutter-build-ipa$(RESET)\n"; \
		printf "\n"; \
		printf "$(RED)━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━$(RESET)\n"; \
		printf "\n"; \
